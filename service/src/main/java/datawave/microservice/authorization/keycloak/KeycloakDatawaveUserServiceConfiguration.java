...
/**
 * Configuration to supply beans for the {@link KeycloakDatawaveUserService}. This configuration is
 * only active when the "keycloak" profile is selected. This profile is used for retrieving entity
...
public class KeycloakDatawaveUserServiceConfiguration {
  @Bean
  public KeycloakDatawaveUserService keycloakDatawaveUserService(
  ...
  @Bean
  public KeycloakDatawaveUserLookup keycloakDatawaveUserLookup(
      KeycloakDULProperties keycloakDULProperties) {
